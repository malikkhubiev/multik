...
- Клиенты могут переключаться между проектами, по ссылкам которых они переходили
- Команда `/projects` показывает список всех посещенных проектов
- Кнопка переключения позволяет быстро сменить контекст общения
- История посещений сохраняется автоматически
...
7. ✅ Переключение между проектами клиента
8. ✅ Команда /projects для просмотра истории
9. ✅ Автоматическое сохранение истории посещений
